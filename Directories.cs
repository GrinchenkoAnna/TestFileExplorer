...
namespace TestFileExplorer
{
    public class Directories
    {
        ...
        public async void GetNameOfCopiedItem()
        {
            ...
            Directory.CreateDirectory(@"C:\get_name_of_copied_item_test_folder\folder — копия");
            Directory.CreateDirectory(@"C:\get_name_of_copied_item_test_folder\folder — копия — копия");
            ...
            //проверка
            Assert.True(result1 == "folder — копия — копия — копия" 
                && result2 == "folder1 — копия"
                && result3 == "folder2");
        }
